Example code for primary PROTECT analysis
================
...
The only input options to this function is the output from the
...
After the bootstrap process has completed, you should save the results
